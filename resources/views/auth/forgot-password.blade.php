...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .alert-error { background-color:#ff0033; color:white; padding:.8rem 1rem; border-radius:10px; margin-top:.5rem; margin-bottom:1rem; text-align:center; box-shadow:0 0 10px #ff0033; font-weight:bold; font-size:.9rem; }
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <p style="text-align:center; margin-bottom:1.5rem; color:#fff; text-shadow:0 0 5px #00ffcc;">
                Ingresa tu correo registrado y te enviaremos un enlace para restablecer la contraseña.
            </p>
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="form-actions">
                    <button type="submit" class="neon-btn">Enviar enlace para restablecer contraseña</button>
