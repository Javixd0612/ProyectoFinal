<nav x-data="{ open: false }" class="gamer-nav" aria-label="Primary">
    {{-- Menú dentro del container (solo la parte izquierda) --}}
    <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="nav-inner flex items-center h-16">
            <!-- LEFT: Secciones (solo izquierda) -->
            <div class="left-sections flex items-center gap-6 w-full">
            ...
            <!-- Mobile hamburger (a la derecha dentro del container en móviles) -->
            <div class="mobile-hamburger sm:hidden">
    ...
    {{-- Perfil fijado AL EXTERIOR del container para no dejar hueco en el nav --}}
    <div class="fixed-profile" x-data="{ profileOpen: false }" @click.outside="profileOpen = false">
        @auth
            <div class="relative">
